...
![spring-initializer](https://github.com/acc-trainings-org/SpringBoot-CloudNative-Training/blob/main/img/spring-initializer.gif)
...
#### **`Run the application`**
![run application](https://github.com/acc-trainings-org/SpringBoot-CloudNative-Training/blob/main/img/run-spring.gif)
